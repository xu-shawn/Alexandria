...
[[nodiscard]] int GetRHScore(const Position* pos, const SearchData* sd, const Move move, const int ply);
...
[[nodiscard]] int GetHistoryScore(const Position* pos, const SearchData* sd, const Move move, const SearchStack* ss, const int ply);
